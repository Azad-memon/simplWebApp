...
<body>
    ...
    // Add current page URL to the data
                                ...
                                <form action="http://localhost/SimplePos/Billrecipt.php" method="POST" target="_blank" class="d-inline">
                                        ...
                                        <form action="http://localhost/SimplePos/KotBill.php" method="POST"  class="d-inline">
                                            @csrf
