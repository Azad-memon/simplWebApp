    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.size.index') }}" class="btn btn-dark mt-3">← Back to Size</a>
            </div>
            <div class="card-body">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card shadow-sm border-0 h-100">
                                    ...
                                    <form class="translation-form" data-lang="{{ $language->code }}" method="POST"
                                        ...
                                        <input type="hidden" name="translatable_type"
                                            value="{{ get_class($translations) }}">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="title_{{ $language->id }}" value="{{ $title?->meta_value }}">
                                            </div>
