...
<div class="container-fluid">
    ...
    <div class="page-title-box">
        <h4 class="page-title">Translate: {{ $translations->ing_name }}</h4>
    </div>

    <!-- Translations Table -->
   <div class="card">
                <div class="card-header">
               <a href="{{ route('admin.ingredient.index') }}" class="btn btn-dark mt-3">← Back to Ingredients</a>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-primary text-white py-3">
                 ...
                 <form class="translation-form" data-lang="{{ $language->code }}" method="POST"
                    ...
                    <input type="hidden" name="translatable_id" value="{{ $translations->ing_id }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="description_{{ $language->id }}" class="form-label fw-bold">Description</label>
                            <textarea
                                class="form-control  summernote @error('description') is-invalid @enderror"
                                name="description"
                                id="description_{{ $language->id }}"
                                rows="4">{{ $description?->meta_value }}</textarea>
                        </div>
                    </div>
