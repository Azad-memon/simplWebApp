            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                     ...
                     <a href="#" class="btn btn-primary" id="add-language" style="float: right">Add</a>
                                    ...
                                    <tbody>
                                        @foreach ($languages as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                   <a href="#" class="btn btn-success" id="edit-language"
                                                    ...
                                                    <a class="btn btn-danger theme delete-btn"
                                                        ...
                                                        data-id=""
                                                        data-action="{{ route('admin.languages.delete', ['id' => Crypt::encrypt($item->id)]) }}"
                                                        type="button" data-original-title="btn btn-danger " title=""
                                                        data-bs-original-title=""><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
